    ...
    <>
      ...
      <div className="mt-8 grid gap-4 lg:grid-cols-2">
        <EmptyState
          ...
          primaryAction={
            <a href={`/students/new`} className="rounded-md bg-gradient-primary px-4 py-2 text-sm font-medium text-white">
              নতুন ভর্তি
            </a>
          }
          secondaryAction={
            <a href={`/students/bulk-import`} className="rounded-md border border-border px-4 py-2 text-sm">
              Excel থেকে import
            </a>
          }
        ...
        <EmptyState
          ...
          primaryAction={
            <a href={`/classes`} className="rounded-md bg-gradient-primary px-4 py-2 text-sm font-medium text-white">
              ক্লাস যোগ করুন
            </a>
          }
          secondaryAction={
            <a href={`/settings`} className="rounded-md border border-border px-4 py-2 text-sm">
              সেটিংস
            </a>
          }
        />
