...
const tabs: { key: Tab; label: string; href: (s: string) => string }[] = [
  { key: "invoices",   label: "ইনভয়েস",        href: (s) => `/fees/invoices` },
  { key: "structures", label: "ফি কাঠামো",       href: (s) => `/fees/structures` },
  { key: "heads",      label: "ফি হেড",          href: (s) => `/fees/heads` },
  { key: "payments",   label: "পেমেন্ট লগ",      href: (s) => `/fees/payments` },
];
